...
#define STRING_CONFIG_H_AUTHOR "(leonhma, ai3m_V0.1.0)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD TRIGORILLA_PRO
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.74
    #define DEFAULT_Ki   1.71
    #define DEFAULT_Kd  89.67
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.19
  #define DEFAULT_bedKi  10.53
  #define DEFAULT_bedKd 366.25
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.12 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 47, -4, -1.685 }
...
#define Z_PROBE_SPEED_FAST (2*60)
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR      unreliable
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X  17681
  #define TOUCH_CALIBRATION_Y -11779
  #define TOUCH_OFFSET_X         -26
  #define TOUCH_OFFSET_Y         348
