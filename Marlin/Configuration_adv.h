...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (4*60)    // (seconds) Time without extruder movement to trigger protection
...
#define HOMING_BUMP_MM      { 3, 3, 1 }       // (mm) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  40, 105 }, { 155,  105 }}
  ...
  #define G34_MAX_GRADE              8    // (%) Maximum incline that G34 will handle
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      780  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        25  // (mm) An unretract is done, then this length is purged.
